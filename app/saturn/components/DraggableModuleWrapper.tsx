...
const MODULES = [
  ...
  { id: 'blackjack', label: 'Blackjack',  defaultX: 1120, defaultY: 130, defaultWidth: 680, defaultHeight: 680, minWidth: 450, minHeight: 450, maxWidth: 1125, maxHeight: 1125, Component: BlackjackModule },
]
